...
import { logoutUserServerAction } from "@/actions/logout";
...
function Header() {
  ...
  async function handleUserLogout() {
    const result = await logoutUserServerAction();
            ...
            <div className="flex items-center space-x-4">
              <div className="relative hidden md:block">
                <Input
                  ...
                  className="pl-10 pr-4 w-64 rounded-full bg-gray-100 border-0 focus-visible:ring-1"
                />
